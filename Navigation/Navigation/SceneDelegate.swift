...
//
//    func createDevicesNavigationController() -> UINavigationController {
//
//        let devicesVC = DevicesViewController()
//        devicesVC.title = "Devices"
//        devicesVC.tabBarItem = UITabBarItem(title: "Devices", image: UIImage(systemName: "list.bullet.rectangle"), tag: 0)
//
//        return  UINavigationController(rootViewController: devicesVC)
//
//    }
//
...
//        tabbar.viewControllers = [createDevicesNavigationController(), createGroupsNavigationController()]
//
//        return tabbar
//
//    }
